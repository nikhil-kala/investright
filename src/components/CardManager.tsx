...
import { WebSearchService, CardSearchResult, SearchProgress } from '../services/webSearchService';
...
export default function CardManager() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      // Use the new webSearchService for comprehensive search
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Credit Card Manager</h1>
        <p className="text-gray-600">Search and manage your credit cards</p>
      </div>
        ...
        <form onSubmit={handleSearch} className="flex gap-4 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Search for credit cards (e.g., 'simply save', 'platinum', 'gold')"
