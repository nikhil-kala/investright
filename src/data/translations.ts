...
export const translations: Record<string, LanguageContent> = {
  en: {
    ...
    hero: {
      ...
      secureDesc: "Bank-level security with full regulatory compliance",
      expertGuidance: "Expert Guidance",
      expertDesc: "AI-powered advice tailored for small investors",
      lowFees: "Low Fees",
      lowFeesDesc: "Transparent pricing designed for every budget"
    },
    features: {
  ...
  hi: {
    ...
    hero: {
      ...
      startInvesting: "आज ही निवेश शुरू करें",
      learnMore: "और जानें",
      secureRegulated: "सुरक्षित और नियंत्रित",
      secureDesc: "बैंक स्तरीय सुरक्षा के साथ पूर्ण नियामक अनुपालन",
      expertGuidance: "विशेषज्ञ मार्गदर्शन",
      expertDesc: "छोटे निवेशकों के लिए AI-संचालित सलाह",
      lowFees: "कम शुल्क",
      lowFeesDesc: "हर बजट के लिए डिज़ाइन की गई पारदर्शी मूल्य निर्धारण"
    },
    features: {
    ...
    about: {
      ...
      assetsUnderManagement: "प्रबंधनाधीन संपत्ति",
  ...
  mr: {
    ...
    hero: {
      ...
      startInvesting: "आजच गुंतवणूक सुरू करा",
      learnMore: "अधिक जाणून घ्या",
      secureRegulated: "सुरक्षित आणि नियंत्रित",
      secureDesc: "पूर्ण नियामक अनुपालनासह बँक-स्तरीय सुरक्षा",
      expertGuidance: "तज्ञ मार्गदर्शन",
      expertDesc: "छोट्या गुंतवणूकदारांसाठी AI-चालित सल्ला",
      lowFees: "कमी शुल्क",
      lowFeesDesc: "प्रत्येक बजेटसाठी डिझाइन केलेले पारदर्शक किंमत निर्धारण"
    },
    features: {
    ...
    about: {
      ...
      assetsUnderManagement: "व्यवस्थापनाधीन मालमत्ता",
